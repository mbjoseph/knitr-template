...
setwd("/home/max/Documents/knitr-template") # your working directory
# these are the development versions of the packages - no guarantees
library(devtools)
...
```{r fig1, echo=FALSE, fig.width=7, fig.height=5, dpi=300, out.height=500, out.width=700}
require(ggplot2)
